...
\begin{list3}
\item Finance Area Coordinator, 2023 --
...
\section{\sc Books}
\begin{enumerate}
\item Back, K., Liu, H., and M. Loewenstein, 2025, \href{https://book.derivative-securities.org}{Pricing and Hedging Derivative Securities}.
...
\begin{enumerate}
  \item Back, K., Cocquemas, F., Ekren, I., and A. Lioui, 2025, ``Optimal Transport and Informed Trading in Securities Markets,'' R\&R at \textit{Operations Research}.
\item Back, K., Ober, A., and S. Pruitt, 2025, ``The Virtue of Complexity in Simple Economic Models.''
...
\item Rice University
\begin{list3}
\item Patrick Blonien (Carnegie Mellon)
...
\begin{list1}
\item 2025 Financial Management Association Innovation in Teaching Award
\item 2023 Financial Management Association Innovation in Teaching Award (joint with Kevin Crotty).
...
\item \href{http://learn-investments.rice-business.org}{Learn Investments at Rice Business}.
...
\begin{list1}
  \item Western Finance Association Keynote Speaker, 2024.
