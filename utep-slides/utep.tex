...
\begin{frame}{BGN Model: Sharpe Ratios}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \input{tables/combined_sharpe_bgn.tex}
    \end{column}
    \begin{column}{0.55\textwidth}
      \centering
      \input{tables/dkkm_bgn_sharpe.tex}
...
\begin{frame}{BGN Model: HJ Distance}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \input{tables/combined_hjd_bgn.tex}
    \end{column}
    \begin{column}{0.55\textwidth}
      \centering
      \input{tables/dkkm_bgn_hjd.tex}
...
\begin{frame}{KP14 Model: Sharpe Ratios}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \input{tables/combined_sharpe_kp14.tex}
    \end{column}
    \begin{column}{0.55\textwidth}
      \centering
      \input{tables/dkkm_kp14_sharpe.tex}
...
\begin{frame}{KP14 Model: HJ Distance}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \input{tables/combined_hjd_kp14.tex}
    \end{column}
    \begin{column}{0.55\textwidth}
      \centering
      \input{tables/dkkm_kp14_hjd.tex}
...
\begin{frame}{GS21 Model: Sharpe Ratios}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \input{tables/combined_sharpe_gs21.tex}
    \end{column}
    \begin{column}{0.55\textwidth}
      \centering
      \input{tables/dkkm_gs21_sharpe.tex}
...
\begin{frame}{GS21 Model: HJ Distance}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \input{tables/combined_hjd_gs21.tex}
    \end{column}
    \begin{column}{0.55\textwidth}
      \centering
      \input{tables/dkkm_gs21_hjd.tex}
...
Paired $t$-tests across simulation panels
  ...
  \vspace{0.3cm}
  \input{tables/ttest_alpha_quad.tex}
